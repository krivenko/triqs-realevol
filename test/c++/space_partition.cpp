...
int main(int argc, char **argv) {
 ...
 for (int o = 0; o < 3; ++o) {
  fops.insert_fermion("up", o);
  fops.insert_fermion("dn", o);
 }

 for (int o = 0; o < 3; ++o) {
  H += -mu * (n<time_expr>("up", o) + n<time_expr>("dn", o));
 }
 for (int o = 0; o < 3; ++o) {
  H += U * n<time_expr>("up", o) * n<time_expr>("dn", o);
 }
 for (int o1 = 0; o1 < 3; ++o1)
  for (int o2 = 0; o2 < 3; ++o2) {
   if (o1 == o2) continue;
   H += (U - 2 * J) * n<time_expr>("up", o1) * n<time_expr>("dn", o2);
  }
 for (int o1 = 0; o1 < 3; ++o1)
  for (int o2 = 0; o2 < 3; ++o2) {
   if (o2 >= o1) continue;
   H += (U - 3 * J) * n<time_expr>("up", o1) * n<time_expr>("up", o2);
   H += (U - 3 * J) * n<time_expr>("dn", o1) * n<time_expr>("dn", o2);
  }

 for (int o1 = 0; o1 < 3; ++o1)
  for (int o2 = 0; o2 < 3; ++o2) {
   if (o1 == o2) continue;
   H += -J * c_dag<time_expr>("up", o1) * c_dag<time_expr>("dn", o1)
           * c<time_expr>("up", o2) * c<time_expr>("dn", o2);
   H += -J * c_dag<time_expr>("up", o1) * c_dag<time_expr>("dn", o2)
           * c<time_expr>("up", o2) * c<time_expr>("dn", o1);
  }
...
TEST(space_partition, MatrixElements) {
 ...
 struct melem_t {
  ...
  bool operator==(melem_t const& me) const {
   ...
   return from == me.from && to == me.to && is_zero(val(t)-me.val(t));
  }
 };
 ...
 for (auto x : melem_map) {
  v_melem[SP.lookup_basis_state(x.first.first)].insert({x.first.first, x.first.second, x.second});
 }
 ...
 melem_set_t ref_melem {
  ...
  std::set<melem_t>{},
  // N=1
  {{d0, d0, -mu}}, {{d1, d1, -mu}}, {{d2, d2, -mu}}, {{u0, u0, -mu}}, {{u1, u1, -mu}}, {{u2, u2, -mu}},
  // N=2, same spin
  {{d0 + d1, d0 + d1, -2 * mu + U - 3 * J}}, {{d0 + d2, d0 + d2, -2 * mu + U - 3 * J}},
  {{d1 + d2, d1 + d2, -2 * mu + U - 3 * J}}, {{u0 + u1, u0 + u1, -2 * mu + U - 3 * J}},
  {{u0 + u2, u0 + u2, -2 * mu + U - 3 * J}}, {{u1 + u2, u1 + u2, -2 * mu + U - 3 * J}},
  // N=2, pair hopping
  {{d0 + u0, d0 + u0, -2 * mu + U}, {d1 + u1, d1 + u1, -2 * mu + U}, {d2 + u2, d2 + u2, -2 * mu + U},
   {d0 + u0, d1 + u1, J},           {d0 + u0, d2 + u2, J},           {d1 + u1, d2 + u2, J},
   {d1 + u1, d0 + u0, J},           {d2 + u2, d0 + u0, J},           {d2 + u2, d1 + u1, J}},
  // N=2, spin flip
  {{d0 + u1, d0 + u1, -2 * mu + U - 2 * J}, {d1 + u0, d1 + u0, -2 * mu + U - 2 * J},
   {d0 + u1, d1 + u0, J},                   {d1 + u0, d0 + u1, J}},
  {{d0 + u2, d0 + u2, -2 * mu + U - 2 * J}, {d2 + u0, d2 + u0, -2 * mu + U - 2 * J},
   {d0 + u2, d2 + u0, J},                   {d2 + u0, d0 + u2, J}},
  {{d1 + u2, d1 + u2, -2 * mu + U - 2 * J}, {d2 + u1, d2 + u1, -2 * mu + U - 2 * J},
   {d1 + u2, d2 + u1, J},                   {d2 + u1, d1 + u2, J}},
  // N=3
  {{d0 + d1 + d2, d0 + d1 + d2, -3 * mu + 3 * U - 9 * J}}, {{u0 + u1 + u2, u0 + u1 + u2, -3 * mu + 3 * U - 9 * J}},
  {{d0 + d1 + u0, d0 + d1 + u0, -3 * mu + 3 * U - 5 * J}, {d1 + d2 + u2, d1 + d2 + u2, -3 * mu + 3 * U - 5 * J},
   {d0 + d1 + u0, d1 + d2 + u2, -J},                      {d1 + d2 + u2, d0 + d1 + u0, -J}},
  {{d0 + d2 + u0, d0 + d2 + u0, -3 * mu + 3 * U - 5 * J}, {d1 + d2 + u1, d1 + d2 + u1, -3 * mu + 3 * U - 5 * J},
   {d0 + d2 + u0, d1 + d2 + u1, J},                       {d1 + d2 + u1, d0 + d2 + u0, J}},
  {{d0 + d1 + u1, d0 + d1 + u1, -3 * mu + 3 * U - 5 * J}, {d0 + d2 + u2, d0 + d2 + u2, -3 * mu + 3 * U - 5 * J},
   {d0 + d1 + u1, d0 + d2 + u2, J},                       {d0 + d2 + u2, d0 + d1 + u1, J}},
  {{d0 + u0 + u1, d0 + u0 + u1, -3 * mu + 3 * U - 5 * J}, {d2 + u1 + u2, d2 + u1 + u2, -3 * mu + 3 * U - 5 * J},
   {d0 + u0 + u1, d2 + u1 + u2, -J},                      {d2 + u1 + u2, d0 + u0 + u1, -J}},
  {{d1 + u0 + u1, d1 + u0 + u1, -3 * mu + 3 * U - 5 * J}, {d2 + u0 + u2, d2 + u0 + u2, -3 * mu + 3 * U - 5 * J},
   {d1 + u0 + u1, d2 + u0 + u2, J},                       {d2 + u0 + u2, d1 + u0 + u1, J}},
  {{d0 + u0 + u2, d0 + u0 + u2, -3 * mu + 3 * U - 5 * J}, {d1 + u1 + u2, d1 + u1 + u2, -3 * mu + 3 * U - 5 * J},
   {d0 + u0 + u2, d1 + u1 + u2, J},                       {d1 + u1 + u2, d0 + u0 + u2, J}},
  {{d1 + d2 + u0, d1 + d2 + u0, -3 * mu + 3 * U - 7 * J}, {d0 + d2 + u1, d0 + d2 + u1, -3 * mu + 3 * U - 7 * J},
   {d0 + d1 + u2, d0 + d1 + u2, -3 * mu + 3 * U - 7 * J}, {d1 + d2 + u0, d0 + d2 + u1, J},
   {d0 + d2 + u1, d1 + d2 + u0, J},                       {d1 + d2 + u0, d0 + d1 + u2, -J},
   {d0 + d1 + u2, d1 + d2 + u0, -J},                      {d0 + d2 + u1, d0 + d1 + u2, J},
   {d0 + d1 + u2, d0 + d2 + u1, J}},
  {{d2 + u0 + u1, d2 + u0 + u1, -3 * mu + 3 * U - 7 * J}, {d0 + u1 + u2, d0 + u1 + u2, -3 * mu + 3 * U - 7 * J},
   {d1 + u0 + u2, d1 + u0 + u2, -3 * mu + 3 * U - 7 * J}, {d2 + u0 + u1, d0 + u1 + u2, -J},
...
TEST(space_partition, Phase2) {
 ...
 for (int o = 0; o < 3; ++o)
  for (auto spin : {"up", "dn"}) {
   Cd.emplace_back(c_dag<time_expr>(spin, o), fops);
   C.emplace_back(c<time_expr>(spin, o), fops);
 ...
 for (auto op : all_ops) {
  for (auto i_sp : cl) {
   ...
   for (auto i : i_sp) {
    ...
    foreach(final_state, [&f_sp](int f, time_expr amplitude) {
