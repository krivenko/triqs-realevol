...
texpr.add_method("bool is_zero()", doc = "Boolean : is zero?")
texpr.add_call(signature="double(double t)", doc="Substitute a time value into the expression")

module.add_class(texpr)

module.add_function(signature="bool is_constant(realevol::time_expr te)", doc="Boolean : is constant expression?")
