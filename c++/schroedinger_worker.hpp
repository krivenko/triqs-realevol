...
enum ode_solve_method { ode_solve_runge_kutta, ode_solve_lanczos };

template<typename Mesh, ode_solve_method Method, bool ComplexOperators = false>
class schroedinger_worker {
public:
    ...
    using initial_state_t = state<hilbert_space,std::complex<double>,true>;
